...
const API_SEARCH =
  "https://api.themoviedb.org/3/search/movie?api_key=16f5a39714623a8f11910f456e72441e&query=";
...
const MovieMain: React.FC = () => {
  ...
  return (
    <div>
      ...
      <SearchMovie changeHandler={changeHandler} handleSubmit={handleSubmit} />
      <DisplayImages>
        {getMovies.length > 0 ? (
          getMovies.map((index) => (
            <div key={index.id}>
